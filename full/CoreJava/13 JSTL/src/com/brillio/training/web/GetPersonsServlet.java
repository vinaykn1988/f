...
public class GetPersonsServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// model data (usually got from service or dao layer)
		List<Person> list = new ArrayList<>();
		list.add(new Person(1, "John", "Doe", 5.9));
		list.add(new Person(2, "Jane", "Doe", 5.5));
		list.add(new Person(3, "Will", "Smith", 5.11));
		list.add(new Person(4, "Ram", "Kumar", 6.2));
		list.add(new Person(5, "Shyam", "Sundar", 6.1));
